...
<body id="main_body" >
	...
	<li><a href="search.php">Найти</a></li>
		...
		<form id="form_703943" class="appnitro"  method="post" action="">
					<div class="form_description">
			<h2>Поиск по реестру</h2>
			<p>Здесь можно найти интересующую вас запись</p>
		</div>						
			<ul >
		...
		<label class="description" for="element_1">Контрагент </label>
		<div>
			<input id="element_1" name="element_1" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_2" >
		<label class="description" for="element_2">Тип документа </label>
		<div>
			<input id="element_2" name="element_2" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_3" >
		<label class="description" for="element_3">№ Документа </label>
		<div>
		...
		<label class="description" for="element_5">Количество </label>
		<div>
			<input id="element_5" name="element_5" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_6" >
		<label class="description" for="element_6">Примечание </label>
		<div>
